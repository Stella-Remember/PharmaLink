...
const OwnerLayout: React.FC<OwnerLayoutProps> = ({ children, activeTab, onTabChange }) => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      {/* Sidebar - Wider width for larger logo */}
      <div className="w-80 flex-shrink-0 flex flex-col bg-white border-r border-gray-200">

        {/* Logo - Much larger */}
        <div className="py-8 px-4 border-b border-gray-200 flex items-center justify-center">
          <img
            src="/logo.png"
            alt="PharmaLink"
        ...
        <div className="px-4 py-4 border-b border-gray-200">
          <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3">
            <div className="w-10 h-10 rounded-full bg-[#1a2235] flex items-center justify-center text-white text-sm font-semibold flex-shrink-0">
              {initials}
            </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:bg-gray-50 hover:text-gray-700 transition-all text-sm font-medium"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Main content - Adjusted margin to accommodate wider sidebar */}
